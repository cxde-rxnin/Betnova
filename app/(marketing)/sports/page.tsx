  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 animate-fade-in">
      <div className="mb-8 flex items-center gap-3">
        ...
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Sports Markets</h1>
          <p className="text-muted-foreground mt-1">Browse live and upcoming matches by sport.</p>
        </div>
      </div>
